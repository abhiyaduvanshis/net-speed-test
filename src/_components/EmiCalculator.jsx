...
export default function EmiCalcultor(){

    const [inputWith,setInputWith] = useState(150)
    const [inputAmountValue,setAmountValue] = useState(5000000)
    ...
    return(
        <main className="container mx-auto px-6 py-12">
            ...
            <p>EMI Calculator is a tool that helps users calculate the Equated Monthly Installment (EMI) for loans,
            such as home loans, car loans, or personal loans. 
            It simplifies financial planning by providing a clear understanding of
            the monthly repayment amount based on the loan amount,
            interest rate, and repayment tenure.</p>
            ...
            <div className="mb-3">
                <h2 className="text-2xl font-semibold mb-3">Key Components of EMI</h2>
                <p>1. <b>Loan Amount (Principal)</b>: The total amount of money borrowed from the lender.</p>
                <p>2. <b>Interest Rate</b>: The annual rate of interest charged by the lender, converted into a monthly rate for EMI</p>
                <p>3. <b>Loan Tenure</b>: The time period (in years or months) over which the loan is to be repaid.</p>
            </div>

            <div className="mb-3">
                <h2 className="text-2xl font-semibold mb-3">EMI Calculator Formula</h2>
            ...
            <div className="mb-3">
                <h2 className="text-2xl font-semibold mb-3">Example of EMI Calculation</h2>
            ...
            <div className="mb-3">
                ...
                <p>An EMI Calculator is an essential financial tool that simplifies loan repayment planning, 
